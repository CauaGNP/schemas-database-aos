...
import { createCategoryService, deleteCategoryByIdService, getAllCategoryService, getCategoryByIdService, updateCategoryByIdService } from "../services/categoryService.js";
...
const updateCategoryById =  async (req: Request, res: Response) => {
    try {
        ...
        await updateCategoryByIdService(categoryId, req.body);
