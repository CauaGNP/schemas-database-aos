...
import { createAccountService, deleteAccountByIdService, getAccountByIdService, getAllAccountsService, updateAccountByIdService } from "../services/accountService.js";
...
const updateAccountById = async (req: Request, res: Response) => {
    try {
        ...
        await updateAccountByIdService(accountId, req.body)
