...
export const transactionTypeEnum = pgEnum("transactionTypeEnum", transactionType);
...
export const transactionTable = pgTable("Transaction", {
    ...
    updated_at: timestamp().defaultNow().$defaultFn(() => new Date()),
    account_id: uuid().notNull().references(() => accountTable.id),
